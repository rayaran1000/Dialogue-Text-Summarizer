...
class ModelTrainer:
    ...
    def train(self):
        ...
        model_pegasus.save_pretrained(os.path.join(self.config.root_dir,"pegasus-samsum-model-train"))
        tokenizer.save_pretrained(os.path.join(self.config.root_dir,"pegasus-samsum-tokenizer-train"))
